...
/* 
   Tujuan : Mencari pengguna berdasarkan index.
   I.S    : List user telah tersedia.
   F.S    : Pengguna yang sesuai dengan index yang diberikan telah ditemukan atau tidak ditemukan.
*/

addressKonser pushKonser(addressKonser first, addressKonser nodeBaru);
/* 
   Tujuan : Menambahkan konser ke dalam list.
   I.S    : List konser telah tersedia.
   F.S    : Konser baru telah ditambahkan ke dalam list konser.
*/

addressKonser pushKonserFromFile(char *fileName, addressKonser first);
/* 
   Tujuan : Menambahkan konser dari file ke dalam list.
   I.S    : List konser telah tersedia.
   F.S    : Konser-konser dari file telah ditambahkan ke dalam list konser.
*/

void pushFromFile(char *fileName, addressKonser first, addressRoot root);
/* 
   Tujuan : Menambahkan data pengguna dari file ke dalam list.
   I.S    : List user telah tersedia.
   F.S    : Data pengguna dari file telah ditambahkan ke dalam list pengguna.
*/
...
/* 
   Tujuan : Menghapus data pengguna dari list.
   I.S    : List user telah tersedia.
   F.S    : Data pengguna yang dipilih telah dihapus dari list dan dari file.
*/
...
/*
   Tujuan : Menampilkan detail informasi pengguna berdasarkan indeks yang diberikan.
   I.S    : List pengguna dan list konser sudah tersedia
   F.S    : Menampilkan detail informasi pengguna yang sesuai dengan indeks dalam list, jenis tiket, dan konser yang dipilih.
*/
